...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.my_prj.autotvin_x_2.dat"
         "c.my_prj.autotvin_x_3.dat"
         "c.my_prj.autotvin_x_4.dat"
         "c.my_prj.autotvin_x_6.dat"
         "c.my_prj.autotvin_x_8.dat"
         "c.my_prj.autotvin_x_10.dat"
         "c.my_prj.autotvin_x_13.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.my_prj.autotvout_score_0.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
